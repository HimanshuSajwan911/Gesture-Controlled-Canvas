...
def draw_canvas(event, current_x, current_y, flags, params):
    ...
    # handle mouse move event
        ...
        # draw only if mouse is down/clicked
        if drawing:
            # draw the line
...
# bind mouse events
cv2.setMouseCallback('Draw', draw_canvas)
